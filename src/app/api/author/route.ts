...
import { AUTHORS_MONTHLY, AUTHORS_QUARTERLY, AUTHORS_YEARLY, GET_LAST_30DAYS_DATA_AUTHOR, getAuthorBasedArticleList, getAuthorBasedArticleListForMonthly, getAuthorBasedArticleListForQuarterly, getAuthorBasedArticleListForYearly, getAuthorBasedArticleListRealTime } from "./authors_list_graphql";
  ...
  try {
    ...
    switch (operation) {
      ...
      case "getLast24HoursForAuthor":
        const getLast24HoursForAuthor = GET_LAST_24HOURS_DATA(variables?.period_date);
      ...
      case "getLast30DaysForAuthor":
        const getLast30DaysForAuthor = GET_LAST_30DAYS_DATA_AUTHOR(variables?.period_date);
