...
import { ChatMessageBubble } from "./chat_message_bubble";
import { UploadDocumentsForm } from "./update_document_form";
import { IntermediateStep } from "./intermediate_step";
...
export function ChatWindow(props: {
  ...
  return (
    <div
      className={`flex flex-col items-center p-4 md:p-8 rounded grow overflow-hidden borderd-chat-window ${
    ...
    >
      ...
      <form onSubmit={sendMessage} className="flex w-full flex-col">
        ...
        <div className="flex w-full mt-4">
          <input
            className="grow mr-8 p-4 rounded chat-input"
            value={input}
