...
export const AuthorTableCard = ({
  ...
  const getAuthorDetailsMonthly = async (
    record: any,
    limit: any,
    offset: any,
    sorting: any
  ...
  const getAuthorDetailsQuarterly = async (
    record: any,
    limit: any,
    offset: any,
    sorting: any
  ...
  const getAuthorDetailsYearly = async (
    record: any,
    limit: any,
    offset: any,
    sorting: any
  ...
  const getAuthorDetailsRealTime = async (
    record: any,
    limit: any,
    offset: any,
    sorting: any
          ...
          <div className="author-table-body">
            <Row gutter={[16, 16]} className="table-card-row">
              ...
              <Col className="text-center" span={1}>
                <div
                  className={`see-btn ${
                    loading || record?.published_articles === 0
                      ? "disabled"
                      : ""
                  }`}
                  onClick={() => {
